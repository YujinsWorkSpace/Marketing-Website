...
export default function MarketingFilter(props) {
  const { overrides: overridesProp, ...rest } = props;
  const variants = [
    {
      variantValues: { property1: "Marketing default" },
      overrides: {
        Vector: {},
        "gridicons:speaker": {},
        Marketing: {},
    ...
    {
      variantValues: { property1: "Marketing active" },
      overrides: {
        Vector: {
          paths: [
            {
        ...
        "gridicons:speaker": {},
        Marketing: { color: "rgba(255,255,255,1)" },
        MarketingFilter: { backgroundColor: "rgba(255,138,0,1)" },
      },
    },
  ];
  ...
  return (
    <Flex
      ...
      display="flex"
      {...getOverrideProps(overrides, "MarketingFilter")}
      {...rest}
    >
      <View
        width="20px"
