...
export default function SortbyReviewbutton(props) {
  const { overrides: overridesProp, ...rest } = props;
  const variants = [
    {
      variantValues: { property1: "Default" },
      overrides: { Reviews: {}, "Line 6": {}, SortbyReviewbutton: {} },
    },
    {
      variantValues: { property1: "hover" },
      overrides: {
        Reviews: { color: "rgba(0,0,0,1)" },
        "Line 6": {},
        SortbyReviewbutton: {},
      },
    },
  ...
  return (
    <Flex
      ...
      display="flex"
      {...getOverrideProps(overrides, "SortbyReviewbutton")}
      {...rest}
    >
      <Text
        fontFamily="Roboto"
