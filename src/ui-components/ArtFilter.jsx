...
export default function ArtFilter(props) {
  const { overrides: overridesProp, ...rest } = props;
  const variants = [
    {
      variantValues: { property1: "Art default" },
      overrides: { Vector: {}, "mdi:art": {}, Art: {}, ArtFilter: {} },
    },
    {
      variantValues: { property1: "Art active" },
      overrides: {
        Vector: {
          paths: [
            {
        ...
        "mdi:art": {},
        Art: { color: "rgba(255,255,255,1)" },
        ArtFilter: { backgroundColor: "rgba(148,128,99,1)" },
      },
    },
  ];
  ...
  return (
    <Flex
      ...
      display="flex"
      {...getOverrideProps(overrides, "ArtFilter")}
      {...rest}
    >
      <View
        width="20px"
