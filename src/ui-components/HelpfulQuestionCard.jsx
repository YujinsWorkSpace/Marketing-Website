...
export default function HelpfulQuestionCard(props) {
  ...
  return (
    <Flex
      ...
      display="flex"
      {...getOverrideProps(overrides, "HelpfulQuestionCard")}
      {...rest}
    >
      <Flex
        gap="30px"
      ...
      >
        ...
        >
          <Icon
            ...
            shrink="0"
            position="relative"
            {...getOverrideProps(overrides, "Vector3877582")}
          ></Icon>
          <Text
            fontFamily="Roboto"
            fontSize="14px"
        ...
        <Flex
          ...
          padding="0px 0px 0px 0px"
          display="flex"
          {...getOverrideProps(overrides, "Frame 1113877584")}
        >
          <Text
            fontFamily="Roboto"
            fontSize="14px"
            ...
            {...getOverrideProps(overrides, "Review Details3877585")}
          ></Text>
          <Text
            fontFamily="Roboto"
            fontSize="12px"
            ...
            {...getOverrideProps(overrides, "Posted Date3877586")}
          ></Text>
        </Flex>
      </Flex>
      <Flex
      ...
      >
        ...
        >
          <Icon
            ...
            shrink="0"
            position="relative"
            {...getOverrideProps(overrides, "Vector3877589")}
          ></Icon>
          <Text
            fontFamily="Roboto"
            fontSize="14px"
        ...
        <Flex
          ...
          padding="0px 0px 0px 0px"
          display="flex"
          {...getOverrideProps(overrides, "Frame 1113877591")}
        >
          <Text
            fontFamily="Roboto"
            fontSize="14px"
            ...
            {...getOverrideProps(overrides, "Review Details3877592")}
          ></Text>
          <Flex
            gap="3px"
            direction="row"
          ...
          >
            <Text
              ...
              {...getOverrideProps(overrides, "Posted Date3877594")}
            ></Text>
            <PromptSeller
              width="73px"
              height="14px"
      ...
      <Text
        ...
        padding="0px 0px 0px 0px"
        whiteSpace="pre-wrap"
        children="5 people find this helpful"
        {...getOverrideProps(overrides, "Posted Date3877596")}
      ></Text>
      <Flex
        gap="15px"
        direction="row"
