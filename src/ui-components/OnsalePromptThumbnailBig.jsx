...
export default function OnsalePromptThumbnailBig(props) {
  const { overrides: overridesProp, ...rest } = props;
  const variants = [
    {
      variantValues: { property1: "on sale" },
      overrides: {
        "16": {},
        "350": {},
        "Rectangle 3": {},
        ...
        "Prompt Intro": {},
        "Frame 34": {},
        OnsalePromptThumbnailBig: {},
      },
    },
    {
      variantValues: { property1: "hover (sale)" },
      overrides: {
        "16": {},
        "350": {},
        "Rectangle 3": {},
  ...
  return (
    <View
      ...
      {...getOverrideProps(overrides, "OnsalePromptThumbnailBig")}
      {...rest}
    >
      <Image
        width="100%"
          ...
          >
                ...
                >
                  ...
                  >
                    <Icon
                      ...
                      left="0%"
                      right="0%"
                      {...getOverrideProps(overrides, "Vector3838403")}
                    ></Icon>
                    <Icon
                      width="18.31px"
                      height="17.49px"
                      ...
                      left="4.19%"
                      right="4.26%"
                      {...getOverrideProps(overrides, "Vector3838404")}
                    ></Icon>
                  </View>
                </View>
                <Text
              ...
              >
                ...
                >
                  <Icon
                    ...
                    left="37.5%"
                    right="37.5%"
                    {...getOverrideProps(overrides, "Vector3838408")}
                  ></Icon>
                  <Icon
                    width="18.75px"
                    height="13.75px"
                    ...
                    left="3.13%"
                    right="3.13%"
                    {...getOverrideProps(overrides, "Vector3838409")}
                  ></Icon>
                </View>
                <Text
                  fontFamily="Roboto"
              ...
              >
                ...
                >
                  <Icon
                    ...
                    left="8.33%"
                    right="11.79%"
                    {...getOverrideProps(overrides, "Vector3838413")}
                  ></Icon>
                </View>
                <Text
                  fontFamily="Roboto"
            ...
            >
              <Salebig
                ...
                saleTag="big"
                {...getOverrideProps(overrides, "sale big")}
              ></Salebig>
              <Text
                fontFamily="Roboto"
                fontSize="16px"
