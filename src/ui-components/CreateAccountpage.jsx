...
export default function CreateAccountpage(props) {
  ...
  const variants = [
    {
      variantValues: { property1: "Create Account" },
      overrides: {
        "Logo Profile": {},
        "Create Account": {},
        "google login button": {},
        ...
        "Line 2": {},
        "Frame 122": {},
        "Email Address3466978": {},
        "email address": {},
        bg3466980: {},
        bg3466979: {},
        "Email Address3466976": {},
        Password3466985: {},
        pawssword: {},
        "Fill 1": {},
        Path3466992: {},
  ...
  return (
    <Flex
      ...
      display="flex"
      {...getOverrideProps(overrides, "CreateAccountpage")}
      {...rest}
    >
      <LogoProfile
        width="50px"
      ...
      <Flex
        ...
        padding="0px 0px 0px 0px"
        display="flex"
        {...getOverrideProps(overrides, "Email Address3466976")}
      >
        <Flex
          padding="0px 0px 0px 0px"
          width="103px"
        ...
        >
          <Text
            ...
            {...getOverrideProps(overrides, "Email Address3466978")}
          ></Text>
        </Flex>
        <Flex
          padding="0px 0px 0px 0px"
          ...
          shrink="0"
          position="relative"
          {...getOverrideProps(overrides, "bg3466979")}
        >
          <Icon
            width="348px"
            height="46.04px"
            ...
            left="0%"
            right="0%"
            {...getOverrideProps(overrides, "bg3466980")}
          ></Icon>
        </Flex>
      </Flex>
      <Flex
        ...
        padding="0px 0px 0px 0px"
        display="flex"
        {...getOverrideProps(overrides, "Password3466983")}
      >
        <Flex
          gap="10px"
          direction="row"
        ...
        >
          <Flex
            ...
            shrink="0"
            position="relative"
            {...getOverrideProps(overrides, "pawssword")}
          >
            <Text
              fontFamily="Roboto"
              fontSize="16px"
              ...
              whiteSpace="pre-wrap"
              children="Password"
              {...getOverrideProps(overrides, "Password3466985")}
            ></Text>
          </Flex>
          <Flex
            padding="0px 0px 0px 0px"
            ...
            shrink="0"
            position="relative"
            {...getOverrideProps(overrides, "Hide3466988")}
          >
            <Icon
              width="13px"
              height="10.32px"
              ...
              left="0%"
              right="0%"
              {...getOverrideProps(overrides, "Hide3466989")}
            >
              <Icon
                width="9.1px"
                height="7.6px"
              ...
              >
                <Icon
                  ...
                  left="31.16%"
                  right="38.4%"
                  {...getOverrideProps(overrides, "Path3466992")}
                ></Icon>
                <Icon
                  width="11.98px"
                  height="10.32px"
                  ...
                  left="0%"
                  right="7.86%"
                  {...getOverrideProps(overrides, "Path3466993")}
                ></Icon>
              </Icon>
            </Icon>
          </Flex>
        ...
        <Flex
          ...
          shrink="0"
          position="relative"
          {...getOverrideProps(overrides, "bg3466986")}
        >
          <Icon
            width="348px"
            height="46.04px"
            ...
            left="0%"
            right="0%"
            {...getOverrideProps(overrides, "bg3466987")}
          ></Icon>
        </Flex>
      </Flex>
      <ButtonCustom
      ...
      >
        <Text
          ...
          {...getOverrideProps(overrides, "Already have an account?")}
        ></Text>
        <Login
          display="flex"
          gap="10px"
