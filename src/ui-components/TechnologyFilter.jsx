...
export default function TechnologyFilter(props) {
  const { overrides: overridesProp, ...rest } = props;
  const variants = [
    {
      variantValues: { property1: "Technology default" },
      overrides: {
        Vector: {},
        "ph:code-fill": {},
        Technology: {},
    ...
    {
      variantValues: { property1: "Technology active" },
      overrides: {
        Vector: {
          paths: [
            {
        ...
        "ph:code-fill": {},
        Technology: { color: "rgba(255,255,255,1)" },
        TechnologyFilter: { backgroundColor: "rgba(148,66,255,1)" },
      },
    },
  ];
  ...
  return (
    <Flex
      ...
      display="flex"
      {...getOverrideProps(overrides, "TechnologyFilter")}
      {...rest}
    >
      <View
        width="20px"
