...
export default function HealthcareFilter(props) {
  const { overrides: overridesProp, ...rest } = props;
  const variants = [
    {
      variantValues: { property1: "Healthcare default" },
      overrides: {
        Vector: {},
        "healthicons:health": {},
        Healthcare: {},
    ...
    {
      variantValues: { property1: "Healthcare active" },
      overrides: {
        Vector: {
          paths: [
            {
        ...
        "healthicons:health": {},
        Healthcare: { color: "rgba(255,255,255,1)" },
        HealthcareFilter: { backgroundColor: "rgba(3,166,0,1)" },
      },
    },
  ];
  ...
  return (
    <Flex
      ...
      display="flex"
      {...getOverrideProps(overrides, "HealthcareFilter")}
      {...rest}
    >
      <View
        width="20px"
