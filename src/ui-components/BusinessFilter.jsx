...
export default function BusinessFilter(props) {
  const { overrides: overridesProp, ...rest } = props;
  const variants = [
    {
      variantValues: { property1: "Business default" },
      overrides: {
        Vector: {},
    ...
    {
      variantValues: { property1: "Business active" },
      overrides: {
        Vector: {
          paths: [
            {
        ...
        "ic:round-business-center": {},
        Business: { color: "rgba(255,255,255,1)" },
        BusinessFilter: { backgroundColor: "rgba(0,131,252,1)" },
      },
    },
  ];
  ...
  return (
    <Flex
      ...
      display="flex"
      {...getOverrideProps(overrides, "BusinessFilter")}
      {...rest}
    >
      <View
        width="20px"
